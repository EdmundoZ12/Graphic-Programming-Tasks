...
namespace Second_Homework_Draw_a_Computer.Componentes
{
    public class CPU
    {
        ...
        private void CrearGabinete(Parte gabinete)
        {
            ...
            caraFrontal.Color = new Vector3(0.15f, 0.15f, 0.15f); // Gris oscuro
            ...
            caraTrasera.Color = new Vector3(0.1f, 0.1f, 0.1f); // Más oscuro
            ...
            caraIzquierda.Color = new Vector3(0.12f, 0.12f, 0.12f); // Gris medio oscuro
            ...
            caraDerecha.Color = new Vector3(0.12f, 0.12f, 0.12f); // Gris medio oscuro
            ...
            caraSuperior.Color = new Vector3(0.18f, 0.18f, 0.18f); // Más claro
            ...
            caraInferior.Color = new Vector3(0.08f, 0.08f, 0.08f); // Muy oscuro
            ...
            panelFrontal.Color = new Vector3(0.0f, 0.5f, 0.0f); // Verde (LED encendido)
