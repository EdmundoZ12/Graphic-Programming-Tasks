...
namespace Transformaciones_OPENGL.Componentes
{
    public class CPU
    {
        Objeto cpu;
        ...
        private void CrearGabinete(Parte gabinete)
        {
            ...
            caraFrontal.Color = new Punto(0.15f, 0.15f, 0.15f);
            ...
            caraIzquierda.Color = new Punto(0.12f, 0.12f, 0.12f);
            ...
            caraDerecha.Color = new Punto(0.12f, 0.12f, 0.12f);
            ...
            caraSuperior.Color = new Punto(0.18f, 0.18f, 0.18f);
            ...
            caraInferior.Color = new Punto(0.08f, 0.08f, 0.08f);
            ...
            panelFrontal.Color = new Punto(0.0f, 0.5f, 0.0f); // Verde
